...
class DataAugmentation:
    def __init__(self, 
                 ...
                 deformation_parameters=(1, 1, 0, 20),
...
def consistency_loss(D, real_samples, material_labels, noise_labels, data_augmentor):
    ...
    augmented_samples, noise_labels_aug = data_augmentor.augment(real_samples)
    # Get discriminator scores for augmented samples
    _, d_augmented = D(augmented_samples, material_labels, noise_labels_aug)
